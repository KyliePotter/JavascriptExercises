...
const removeUnshiftString = () => {
    const removeLast = w3rString.splice(w3rString.length - 1);
    w3rString.unshift(removeLast);
}

let w3rString = ['w3resource'];

function changeString() {
    removeUnshiftString(w3rString);
}
